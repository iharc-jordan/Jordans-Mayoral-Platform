...
- Require the authoritative `Trusted public change-record validation / validate` status check.
...
2. both validation checks are required before merge, with `Trusted public change-record validation / validate` treated as authoritative;
